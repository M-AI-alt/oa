...
public class XbootMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String entityPackage = "cn.exrick.xboot.modules.physics.entity";

    /**
     * dao对应包 【注意修改后需到cn.exrick.xboot.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "cn.exrick.xboot.modules.physics.mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String servicePackage = "cn.exrick.xboot.modules.physics.service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String serviceImplPackage = "cn.exrick.xboot.modules.physics.serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String controllerPackage = "cn.exrick.xboot.modules.physics.controller";
