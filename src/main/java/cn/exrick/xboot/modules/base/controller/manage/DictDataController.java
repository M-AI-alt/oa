...
public class DictDataController{
    ...
    @SystemLog(description = "新增数据字典内容", type = LogType.INSERT)
    ...
    @SystemLog(description = "修改数据字典内容", type = LogType.INSERT)
    ...
    @SystemLog(description = "删除数据字典内容", type = LogType.DELETE)
