...
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Override
    public Department findByDepartmentZwzId(String id) {
        return departmentDao.findByDepartmentZwzId(id);
    }

    @Override
    public Department findByArchiveId(String id) {
        return departmentDao.findByArchiveId(id);
    }

    @Override
    public void deleteNotFlag(String userId) {
        departmentDao.deleteNotFlag(userId);
    }
    ...
    @Override
    public Department findByIdZwz(String id) {
        return departmentDao.findByIdZwz(id);
    }
